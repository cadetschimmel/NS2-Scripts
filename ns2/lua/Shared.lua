...
Script.Load("lua/MiniShade.lua")
Script.Load("lua/MiniCrag.lua")
Script.Load("lua/MiniShift.lua")
Script.Load("lua/Drifter.lua")

Script.Load("lua/Egg.lua")
Script.Load("lua/GorgeEgg.lua")
Script.Load("lua/LerkEgg.lua")
Script.Load("lua/FadeEgg.lua")
Script.Load("lua/OnosEgg.lua")

Script.Load("lua/Embryo.lua")
Script.Load("lua/Cocoon.lua")
Script.Load("lua/Phantasm.lua")
Script.Load("lua/OnosPhantasm.lua")
Script.Load("lua/SporeMine.lua")
...
Script.Load("lua/Weapons/Marine/ExtendedRifle.lua")
