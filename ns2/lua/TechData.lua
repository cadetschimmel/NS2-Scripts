...
function BuildTechData()
    ...
    local techData = { 
        ...
        { [kTechDataId] = kTechId.MarkersMenu,           [kTechDataDisplayName] = "MARKERS", [kTechDataHotkey] = Move.A, [kTechDataTooltipInfo] = "PHEROMONE_TOOLTIP"},
        { [kTechDataId] = kTechId.UpgradesMenu,          [kTechDataDisplayName] = "UPGRADES", [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "TEAM_UPGRADES_TOOLTIP"},
        { [kTechDataId] = kTechId.EggMenu,           	 [kTechDataDisplayName] = "EGGS", [kTechDataHotkey] = Move.D, [kTechDataTooltipInfo] = "EGGS_TOOLTIP"},
		...
		// for direct supply
        { [kTechDataId] = kTechId.SupplyAmmo,              [kTechDataDisplayName] = "AMMO_PACK",           [kTechDataCostKey] = kAmmoPackCost,      [kTechDataHotkey] = Move.A, [kTechDataTooltipInfo] = "AMMO_PACK_TOOLTIP" },
        { [kTechDataId] = kTechId.SupplyMed,               [kTechDataDisplayName] = "MED_PACK",            [kTechDataCostKey] = kMedPackCost,       [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "MED_PACK_TOOLTIP" },
        { [kTechDataId] = kTechId.SupplyCat,               [kTechDataDisplayName] = "CAT_PACK", [kTechDataImplemented] = false,            [kTechDataCostKey] = kCatPackCost,  [kTechDataHotkey] = Move.C, [kTechDataTooltipInfo] = "CAT_PACK_TOOLTIP" },
        ...
        { [kTechDataId] = kTechId.SentryAmmo,          [kStructureAttachId] = kTechId.Sentry, [kStructureAttachRange] = 1.5, [kTechDataMapName] = SentryAmmo.kMapName,           [kTechDataModel] = SentryAmmo.kModelName, [kTechDataDisplayName] = "SENTRY_REFILL",      [kTechDataHotkey] = Move.F,   [kTechDataCostKey] = kSentryAmmoCost, [kTechDataTooltipInfo] = "SENTRY_REFILL_TOOLTIP"},
        { [kTechDataId] = kTechId.PowerPack,             [kTechDataMapName] = "powerpack",                       [kTechDataDisplayName] = "POWER_PACK",          [kTechDataCostKey] = kPowerPackCost,      [kTechDataPointValue] = kPowerPackPointValue, [kTechDataModel] = PowerPack.kModelName,            [kTechDataBuildTime] = kPowerPackBuildTime, [kTechDataMaxHealth] = kPowerPackHealth,  [kTechDataMaxArmor] = kPowerPackArmor, [kTechDataTooltipInfo] = "POWER_PACK_TOOLTIP", [kTechDataHotkey] = Move.S, [kTechDataNotOnInfestation] = true, [kVisualRange] = PowerPack.kRange, [kTechDataInitialEnergy] = 1, [kTechDataMaxEnergy] = kElectrifiedPowerInitialEnergy },
        { [kTechDataId] = kTechId.ElectrifiedPowerPack,   [kTechDataMapName] = ElectrifiedPowerPack.kMapName,                   [kTechDataDisplayName] = "ELECTRIFIED_POWER_PACK",             [kTechDataModel] = PowerPack.kModelName, [kTechDataCostKey] = kPowerPackElectrifyCost, [kTechDataBuildTime] = kPowerPackElectrifyTime, [kTechDataMaxHealth] = kElectrifiedPowerPackHealth, [kTechDataInitialEnergy] = kElectrifiedPowerInitialEnergy, [kTechDataMaxEnergy] = kElectrifiedPowerEnergy, [kTechDataPointValue] = kElectrifiedPowerPackPointValue, [kTechDataNotOnInfestation] = true, [kVisualRange] = PowerPack.kRange, [kTechDataEngagementDistance] = PowerPack.kShockRange, [kTechDataTooltipInfo] = "ELECTRIFIED_POWER_PACK_TOOLTIP", [kTechDataUpgradeTech] = kTechId.PowerPack},         
         

        // MACs 
        { [kTechDataId] = kTechId.MACMine,          [kTechDataBuildTime] = 0, [kTechDataModel] = MACMine.kModelName, 			[kTechDataMapName] = MACMine.kMapName,             [kTechDataDisplayName] = "LAY_MINE", [kTechDataCostKey] = kMACMineCost,         [kTechDataHotkey] = Move.I},
        { [kTechDataId] = kTechId.MACMinesTech,     [kTechDataCostKey] = kTechMinesResearchCost,             [kTechDataResearchTimeKey] = kTechMinesResearchTime, [kTechDataDisplayName] = "MAC_MINES"},
        ...
        { [kTechDataId] = kTechId.ExtendedRifle,         [kTechDataMapName] = ExtendedRifle.kMapName,            [kTechDataDisplayName] = "EXTENDED_RIFLE",         [kTechDataModel] = Rifle.kModelName, [kTechDataDamageType] = kRifleDamageType, [kTechDataCostKey] = kExtendedRifleCost,                                     },
        ...
        { [kTechDataId] = kTechId.JetpackArmorTech,       [kTechDataCostKey] = kJetpackArmorTechResearchCost,         [kTechDataResearchTimeKey] = kJetpackArmorTechResearchTime,     [kTechDataDisplayName] = "JETPACK_ARMOR_TECH", [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "JETPACK_ARMOR_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.ExtendedRifleTech,		 [kTechDataCostKey] = kExtendedRifleTechResearchCost,        [kTechDataResearchTimeKey] = kExtendedRifleTechResearchTime, [kTechDataDisplayName] = "RIFLE_UPGRADE", [kTechDataHotkey] = Move.U, [kTechDataTooltipInfo] = "RIFLE_UPGRADE_TOOLTIP"},
        ...
        // Alien buildables
        { [kTechDataId] = kTechId.Egg,                   [kTechDataMapName] = Egg.kMapName,                         [kTechDataDisplayName] = "EGG",       [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataModel] = Egg.kModelName, [kTechDataPointValue] = kEggPointValue, [kTechDataBuildTime] = 1, [kTechDataCostKey] = kEggCost, [kTechDataMaxExtents] = Vector(Skulk.kXExtents, Skulk.kYExtents, Skulk.kZExtents), [kTechDataRequiresInfestation] = true }, 
		...
		// Egg Types
        { [kTechDataId] = kTechId.GorgeEgg,                 [kTechDataMapName] = GorgeEgg.kMapName, [kTechDataGestateName] = GorgeEgg.kMapName,   [kTechDataBuildTime] = (kGorgeGestateTime / 2), [kTechDataGestateTime] = kGorgeGestateTime, [kTechDataDisplayName] = "GORGE EGG",           					[kTechDataModel] = Egg.kModelName,	[kTechDataCostKey] = kGorgeCost,[kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance, 	[kTechDataMaxExtents] = Vector(Gorge.kXZExtents, Gorge.kYExtents, Gorge.kXZExtents),[kTechDataPointValue] = kEggPointValue, [kTechDataRequiresInfestation] = true},
        { [kTechDataId] = kTechId.LerkEgg,                  [kTechDataMapName] = LerkEgg.kMapName, [kTechDataGestateName] = LerkEgg.kMapName,     [kTechDataBuildTime] = (kLerkGestateTime / 2),  [kTechDataGestateTime] = kLerkGestateTime,  [kTechDataDisplayName] = "LERK EGG",            					[kTechDataModel] = Egg.kModelName,	[kTechDataCostKey] = kLerkCost, [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance, 	[kTechDataMaxExtents] = Vector(Lerk.XZExtents, Lerk.YExtents, Lerk.XZExtents), 		[kTechDataPointValue] = kEggPointValue, [kTechDataRequiresInfestation] = true},
        { [kTechDataId] = kTechId.FadeEgg,                  [kTechDataMapName] = FadeEgg.kMapName, [kTechDataGestateName] = FadeEgg.kMapName,     [kTechDataBuildTime] = (kFadeGestateTime / 2),  [kTechDataGestateTime] = kFadeGestateTime,  [kTechDataDisplayName] = "FADE EGG",            					[kTechDataModel] = Egg.kModelName,	[kTechDataCostKey] = kFadeCost, [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance,  	[kTechDataMaxExtents] = Vector(Fade.XZExtents, Fade.YExtents, Fade.XZExtents), 		[kTechDataPointValue] = kEggPointValue, [kTechDataRequiresInfestation] = true},        
        { [kTechDataId] = kTechId.OnosEgg,                  [kTechDataMapName] = OnosEgg.kMapName, [kTechDataGestateName] = OnosEgg.kMapName,     [kTechDataBuildTime] = (kOnosGestateTime / 2),  [kTechDataGestateTime] = kOnosGestateTime,  [kTechDataDisplayName] = "ONOS EGG",[kTechDataImplemented] = false,	[kTechDataModel] = Egg.kModelName,	[kTechDataCostKey] = kOnosCost, [kTechDataMaxHealth] = Egg.kHealth, [kTechDataMaxArmor] = Egg.kArmor, [kTechDataEngagementDistance] = kOnosEngagementDistance, 		[kTechDataMaxExtents] = Vector(Onos.XExtents, Onos.YExtents, Onos.ZExtents), 		[kTechDataPointValue] = kEggPointValue, [kTechDataRequiresInfestation] = true},
        ...
        // Upgrade structures and research
 		{ [kTechDataId] = kTechId.Morpher,         [kTechDataMapName] = Morpher.kMapName,        [kTechDataDisplayName] = "MORPHER",  [kTechDataCostKey] = kMorpherCost,     [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.R,       [kTechDataBuildTime] = kMorpherBuildTime, [kTechDataModel] = Morpher.kModelName, [kTechDataMaxHealth] = kMorpherHealth, [kTechDataMaxArmor] = kMorpherArmor, [kTechDataPointValue] = kMorpherPointValue, [kTechDataTooltipInfo] = "MORPHER_TOOLTIP", [kTechDataGrows] = false},

        
        { [kTechDataId] = kTechId.MiniCrag,                  [kTechDataMapName] = MiniCrag.kMapName,                         [kTechDataDisplayName] = "MINI_CRAG",  [kTechDataCostKey] = kMiniCragCost,     [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kMiniCragBuildTime, [kTechDataModel] = MiniCrag.kModelName,           [kTechDataMaxHealth] = kMiniCragHealth, [kTechDataMaxArmor] = kMiniCragArmor,   [kTechDataInitialEnergy] = kMiniCragInitialEnergy,      [kTechDataMaxEnergy] = kMiniCragMaxEnergy, [kTechDataPointValue] = kMiniCragPointValue, [kVisualRange] = MiniCrag.kHealRadius, [kTechDataTooltipInfo] = "MINI_CRAG_TOOLTIP", [kTechDataGrows] = false},
        { [kTechDataId] = kTechId.MiniShift,                  [kTechDataMapName] = MiniShift.kMapName,                         [kTechDataDisplayName] = "MINI_SHIFT",  [kTechDataCostKey] = kMiniShiftCost,     [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kMiniShiftBuildTime, [kTechDataModel] = MiniShift.kModelName,           [kTechDataMaxHealth] = kMiniShiftHealth, [kTechDataMaxArmor] = kMiniShiftArmor,   [kTechDataInitialEnergy] = kMiniShiftInitialEnergy,      [kTechDataMaxEnergy] = kMiniShiftMaxEnergy, [kTechDataPointValue] = kMiniShiftPointValue, [kVisualRange] = MiniShift.kEnergizeRadius, [kTechDataTooltipInfo] = "MINI_SHIFT_TOOLTIP", [kTechDataGrows] = false},
        { [kTechDataId] = kTechId.MiniShade,                  [kTechDataMapName] = MiniShade.kMapName,                         [kTechDataDisplayName] = "MINI_SHADE",  [kTechDataCostKey] = kMiniShadeCost,     [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.C,       [kTechDataBuildTime] = kMiniShadeBuildTime, [kTechDataModel] = MiniShade.kModelName,           [kTechDataMaxHealth] = kMiniShadeHealth, [kTechDataMaxArmor] = kMiniShadeArmor,   [kTechDataInitialEnergy] = kMiniShadeInitialEnergy,      [kTechDataMaxEnergy] = kMiniShadeMaxEnergy, [kTechDataPointValue] = kMiniShadePointValue, [kVisualRange] = MiniShade.kDistortRadius, [kTechDataTooltipInfo] = "MINI_SHADE_TOOLTIP", [kTechDataGrows] = false},
        
        { [kTechDataId] = kTechId.UpgradeMiniCrag,           [kTechDataMapName] = MiniCrag.kMapName,                         [kTechDataDisplayName] = "CRAG_UPGRADE",  [kTechDataCostKey] = kCragCost, [kTechDataResearchTimeKey] = kUpgradeMiniCragResearchTime, [kTechDataHotkey] = Move.U, [kTechDataModel] = MiniCrag.kModelName,  [kTechDataMaxHealth] = kCragHealth, [kTechDataMaxArmor] = kCragArmor,[kTechDataTooltipInfo] = "CRAG_TOOLTIP", [kTechDataGrows] = true },
        { [kTechDataId] = kTechId.UpgradeMiniShift,           [kTechDataMapName] = MiniShift.kMapName,                         [kTechDataDisplayName] = "SHIFT_UPGRADE",  [kTechDataCostKey] = kShiftCost, [kTechDataResearchTimeKey] = kUpgradeMiniShiftResearchTime, [kTechDataHotkey] = Move.U, [kTechDataModel] = MiniShift.kModelName,  [kTechDataMaxHealth] = kShiftHealth, [kTechDataMaxArmor] = kShiftArmor,[kTechDataTooltipInfo] = "SHIFT_TOOLTIP", [kTechDataGrows] = true },
        { [kTechDataId] = kTechId.UpgradeMiniShade,           [kTechDataMapName] = MiniShade.kMapName,                         [kTechDataDisplayName] = "SHADE_UPGRADE",  [kTechDataCostKey] = kShadeCost, [kTechDataResearchTimeKey] = kUpgradeMiniShadeResearchTime, [kTechDataHotkey] = Move.U, [kTechDataModel] = MiniShade.kModelName,  [kTechDataMaxHealth] = kShadeHealth, [kTechDataMaxArmor] = kShadeArmor,[kTechDataTooltipInfo] = "SHADE_TOOLTIP", [kTechDataGrows] = true },
        ...
        { [kTechDataId] = kTechId.Whip,                  [kTechDataMapName] = Whip.kMapName,                         [kTechDataDisplayName] = "WHIP",  [kTechDataCostKey] = kWhipCost,    [kTechDataRequiresInfestation] = true, [kTechDataHotkey] = Move.F,        [kTechDataBuildTime] = kWhipBuildTime, [kTechDataModel] = Whip.kModelName,           [kTechDataMaxHealth] = kWhipHealth, [kTechDataMaxArmor] = kWhipArmor,   [kTechDataDamageType] = kDamageType.Structural, [kTechDataInitialEnergy] = kWhipInitialEnergy,      [kTechDataMaxEnergy] = kWhipMaxEnergy, [kVisualRange] = Whip.kRange, [kTechDataPointValue] = kWhipPointValue, [kTechDataTooltipInfo] = "WHIP_TOOLTIP", [kTechDataGrows] = true},
		...
		{ [kTechDataId] = kTechId.SporeMine,             [kTechDataMapName] = SporeMine.kMapName,       			 [kTechDataDisplayName] = "SPOREMINE",       [kTechDataCostKey] = 0, 				[kTechDataBuildTime] = 1, 				[kTechDataMaxHealth] = 5, 			 [kTechDataMaxArmor] = 0, 			[kTechDataModel] = SporeMine.kModelName, [kVisualRange] = SporeMine.kTriggerRange, [kTechDataRequiresInfestation] = true, [kTechDataPointValue] = 0, [kTechDataGrows] = false},
        ...
        { [kTechDataId] = kTechId.ShiftRecall,           [kTechDataDisplayName] = "RECALL",      [kTechDataTooltipInfo] = "SHIFT_RECALL_TOOLTIP"},
 		{ [kTechDataId] = kTechId.ShiftEnergize,              [kTechDataDisplayName] = "ENERGIZE",    [kTechDataHotkey] = Move.H,                       [kTechDataCostKey] = kShiftEnergizeCost, [kTechDataTooltipInfo] = "SHIFT_ENERGIZE_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.OnosTech,                  [kTechDataDisplayName] = "ONOS", [kTechDataHotkey] = Move.C, [kTechDataCostKey] = kOnosResearchCost, [kTechDataResearchTimeKey] =  kOnosResearchTime},        

        
        // General alien upgrades
        
        { [kTechDataId] = kTechId.Melee1Tech,                  [kTechDataDisplayName] = "ALIEN_MELEE1", [kTechDataHotkey] = Move.Q, [kTechDataCostKey] = kMelee1ResearchCost, [kTechDataResearchTimeKey] = kMelee1ResearchTime},        
        { [kTechDataId] = kTechId.Melee2Tech,                  [kTechDataDisplayName] = "ALIEN_MELEE2", [kTechDataHotkey] = Move.W, [kTechDataCostKey] = kMelee2ResearchCost, [kTechDataResearchTimeKey] =  kMelee2ResearchTime},        
        { [kTechDataId] = kTechId.Melee3Tech,                  [kTechDataDisplayName] = "ALIEN_MELEE3", [kTechDataHotkey] = Move.E, [kTechDataCostKey] = kMelee3ResearchCost, [kTechDataResearchTimeKey] =  kMelee3ResearchTime},        
        ...
        { [kTechDataId] = kTechId.AlienArmor2Tech,             [kTechDataDisplayName] = "ALIEN_ARMOR2", [kTechDataHotkey] = Move.S, [kTechDataCostKey] = kAlienArmor2ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor2ResearchTime},        
        { [kTechDataId] = kTechId.AlienArmor3Tech,             [kTechDataDisplayName] = "ALIEN_ARMOR3", [kTechDataHotkey] = Move.D, [kTechDataCostKey] = kAlienArmor3ResearchCost, [kTechDataResearchTimeKey] =  kAlienArmor3ResearchTime},
        ...
        { [kTechDataId] = kTechId.BlinkTech,                 [kTechDataDisplayName] = "BLINK_FADE", [kTechDataCostKey] = kBlinkResearchCost, [kTechDataResearchTimeKey] = kBlinkResearchTime },               
